...
namespace Metagame
{
    public class AdsTester : MonoBehaviour, IUnityAdsInitializationListener, IUnityAdsLoadListener, IUnityAdsShowListener
    {
        ...
        private Button ShowRewardAdButton;
        private Button ShowBannerAdButton;
        private Button HideBannerAdButton;
        #endregion
        ...
        {
            Coins = Int32.Parse(coinText.text);
