public static class ItemFactory 
{
    ...
    public static Item CreateItemFromInventory(ItemSO itemSo) //TODO: FIX STATIC!
    {
        ...
        if (itemSo is UpgradeMaterialSO upgradeMaterialSo)
        {
            var upgradeMaterial = new UpgradeMaterial();
            upgradeMaterial.ItemName = itemSo.ItemName;
            upgradeMaterial.ItemSprite = itemSo.ItemSprite;
